...
//
//       Filename:  D:\NXOPEN\USER\Application\move.hpp
//
...
#include <NXOpen/Features_MoveBodyBuilder.hxx>
...
public:
    ...
    // of these prototypes is provided in the move.cpp file. 
...
private:
    ...
    std::vector<tag_t> tempPtTags;
    NXOpen::Point3d wcsOrigin;
        bool point0SetByUser;
    bool point01SetByUser;
    std::vector<NXOpen::NXObject*> GetSelectionObjects();
